  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.footer}>Already have an account? <Link style={styles.link} to="/login">Sign in</Link></p>
      </div>
    </div>
  );
};
...
const styles = {
  ...
  card: {
    ...
    border: '1px solid rgba(255,255,255,0.15)', padding: '50px 40px',
    borderRadius: '20px', width: '400px', textAlign: 'center',
